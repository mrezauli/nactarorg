<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('list-intakes') }}" :active="request()->routeIs('list-intakes')">
                        {{ __('List Intakes') }}
                    </x-jet-nav-link>
                ...
                <div class="relative ml-3">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('additional-info') }}">
                                {{ __('Additional Info') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('attachments') }}">
                                {{ __('Attachments') }}
                            </x-jet-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('list-intakes') }}" :active="request()->routeIs('list-intakes')">
                {{ __('List Intakes') }}
            </x-jet-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-jet-responsive-nav-link href="{{ route('additional-info') }}"  :active="request()->routeIs('additional-info')">
                    {{ __('Additional Info') }}
                </x-jet-responsive-nav-link>
