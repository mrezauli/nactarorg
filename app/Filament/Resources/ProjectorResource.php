...
use App\Filament\Resources\ProjectorResource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\ProjectorResource\RelationManagers;
...
class ProjectorResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateProjector::route('/create'),
            'view' => Pages\ViewProjector::route('/{record}'),
            'edit' => Pages\EditProjector::route('/{record}/edit'),
        ];
    }
