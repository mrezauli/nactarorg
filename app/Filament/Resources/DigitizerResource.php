...
use App\Filament\Resources\DigitizerResource\Pages;
use App\Filament\Resources\DigitizerResource\RelationManagers;

class DigitizerResource extends Resource
{
    protected static ?string $model = Digitizer::class;
    ...
    {
        return [
            'index' => Pages\ListDigitizers::route('/'),
            'create' => Pages\CreateDigitizer::route('/create'),
            'view' => Pages\ViewDigitizer::route('/{record}'),
            'edit' => Pages\EditDigitizer::route('/{record}/edit'),
        ];
    }
