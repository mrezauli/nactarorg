...
use App\Filament\Resources\CableResource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\CableResource\RelationManagers;

class CableResource extends Resource
{
    protected static ?string $model = Cable::class;
    ...
    {
        return [
            'index' => Pages\ListCables::route('/'),
            'create' => Pages\CreateCable::route('/create'),
            'view' => Pages\ViewCable::route('/{record}'),
            'edit' => Pages\EditCable::route('/{record}/edit'),
        ];
    }
